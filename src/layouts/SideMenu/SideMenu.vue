...
<template>
  <div class="py-5 md:py-0">
    ...
    <div class="flex overflow-hidden">
      ...
      <!-- BEGIN: Content -->
      <div :class="[
          'max-w-full md:max-w-none rounded-[30px] md:rounded-none px-4 md:px-[22px] min-w-0 min-h-screen bg-slate-100 flex-1 md:pt-20 pb-44 mt-5 md:mt-1 relative dark:bg-darkmode-700',
